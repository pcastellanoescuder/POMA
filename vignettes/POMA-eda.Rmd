...
if (nrow(nas) >= 1){
  ggplot2::ggplot(nas, ggplot2::aes(reorder(names, number), number, fill = number)) +
    ...
    ggplot2::xlab("") +
    ggplot2::ggtitle("Missing Value Plot") +
    ggplot2::theme_bw() + 
...
PomaBoxplots(imputed, jitter = jttr,
                   label_size = 8,
                   legend_position = "bottom") +
  ggplot2::ggtitle("Not Normalized")

PomaBoxplots(pre_processed, jitter = jttr, 
                   label_size = 8,
                   legend_position = "bottom") +
