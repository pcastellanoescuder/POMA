...
## R Package for Statistical Analysis of Metabolomic Data
  ...
  [![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/pcastellanoescuder/POMA_package?branch=master&svg=true)](https://ci.appveyor.com/project/pcastellanoescuder/POMA_package)
